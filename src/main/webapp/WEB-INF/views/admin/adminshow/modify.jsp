...
<div>
	...
	<spring:message code="admin.show.modify" />
	</h3>
	<hr class="testhr1">
	<br>
</div>
...
<!-- 공연수정 테이블 -->
<form:form modelAttribute="adminShow" action="modify" enctype="multipart/form-data">
	<table style="width: 900px;">
		...
		<tr>
			<!-- 공연 첨부파일 -->
		 	<td style="text-align:center; background-color: #ececec;">기존 <spring:message code="admin.show.file" /></td>
			<td><img src = "display?showNum=${adminShow.showNum}" width="230" height="150" ></td>
		</tr>
		
		<tr>
			<!-- 공연 첨부파일 선택 -->
			<td style="text-align:center; background-color: #ececec;">변경할 <spring:message code="admin.show.file" /></td>
