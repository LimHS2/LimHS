...
import com.me.common.security.CustomAccessDeniedHandler;
import com.me.common.security.CustomLoginSuccessHandler;
import com.me.common.security.CustomUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.rememberMe().key("userId").tokenRepository(createJDBCRepository()).tokenValiditySeconds(60 * 60 * 24);

		http.authorizeRequests().antMatchers("/user/**").authenticated().antMatchers("/admin/**").hasRole("ADMIN")
