...
import com.me.service.AdminNoticeService;
...
public class AdminNoticeController {
	...
	// @PreAuthorize("hasRole('ROLE_ADMIN')")  // 관리자 권한 부여
	public String register(AdminNotice adminNotice, RedirectAttributes rttr) throws Exception {
		service.register(adminNotice);

		rttr.addFlashAttribute("msg", "SUCCESS");

		return "redirect:/admin/adminNotice/list";
	}
	...
	/* @PreAuthorize("hasRole('ROLE_ADMIN')") */ // 관리자 권한 부여
	public void modifyForm(int noticeNum, Model model) throws Exception {

		model.addAttribute(service.read(noticeNum));
	}

	// 공지사항 수정 처리, 페이징 요청 정보를 매개변수로 받고 다시 뷰에 전달
	@RequestMapping(value = "/modify", method = RequestMethod.POST)
	/* @PreAuthorize("hasRole('ROLE_ADMIN')") */ // 관리자 권한 부여
	public String modify(AdminNotice adminNotice, PageRequest pageRequest, RedirectAttributes rttr) throws Exception {
		service.modify(adminNotice);
	...
	/* @PreAuthorize("hasRole('ROLE_ADMIN')") */ // 관리자 권한 부여
	public String remove(int noticeNum, PageRequest pageRequest, RedirectAttributes rttr) throws Exception {
