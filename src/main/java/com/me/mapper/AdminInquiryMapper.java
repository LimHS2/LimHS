...
public interface AdminInquiryMapper {
	...
	// 문의사항 등록 처리
	public void create(AdminInquiry adminInquiry) throws Exception;
	...
	// 문의사항 수정 처리
	public void update(AdminInquiry adminInquiry) throws Exception;

	// 문의사항 삭제 처리
	public void delete(Integer inquiryNum) throws Exception;
