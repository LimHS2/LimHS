...
<!-- 상세보기 테이블 -->
<form:form modelAttribute="userNotice" action="modify" enctype="multipart/form-data">
	...
	<table style="width: 900px;">
		<tr>
			...
			<td><form:input path="noticeTitle" readonly="true" style="width:800px;" /></td>
		</tr>
		<tr style="height: 400px;">
			<td style="text-align:center; background-color: #ececec;"><spring:message code="adminNotice.content" /></td>
			<td><form:textarea path="noticeContent" readonly="true" style="height: 400px; width:800px;" /></td>
		</tr>
		<tr>
...
<script>
	$(document).ready(function() {
		...
		var formObj = $("#userNotice");

		console.log(formObj);

		$("#btnEdit").on("click", function() {
			var noticeNum = $("#noticeNum");
			var noticeNumVal = noticeNum.val();

			self.location = "modify?noticeNum=" + noticeNumVal;
		});
...
$(document).ready(function() {
	...
	var noticeNum = ${userNotice.noticeNum};
	
	console.log("noticeNum : " + noticeNum);

	$.getJSON("/userNotice/getAttach/"+noticeNum,function(list){
		$(list).each(function(){
			...
			var str = "<div><a href='/userNotice/download"+data+"'>" + getOriginalName(data)+"</a></div>";
